...
const Hiremobile = () => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = require("../Asset/Hire Mobile Developers banner.png");
    img.onload = () => setIsLoaded(true);
  }, []);


  return (
    <div className='hiremobile'>
      {/* 1 section */}
      <div className="hiremobile-front-page"style={{ display: isLoaded ? "flex" : "none" }}>
      <div className="container p-0">
          {/* Left Side Content */}
          <div className="hiremobile-front-page-center row">
            <div className="col-md-6 hiremobile-front-heading p-0">
      ...
      {/* 3 section  */}
      <div className='hiremobile-content-form'>
