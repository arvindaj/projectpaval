...
const Hirefullstack = () => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = require("../Asset/Hire Full Stack Developers banner.png");
  ...
  return (
    <div className='hirefullstack'>
      {/* 1 section */}
      <div className="hirefullstack-front-page" style={{ display: isLoaded ? "flex" : "none" }}>
      <div className="container p-0">
          {/* Left Side Content */}
          <div className="hirefullstack-front-page-center row">
            <div className="col-md-6 hirefullstack-front-heading p-0">
              <h1>Hire FullStack</h1>
              <p>
        ...
        <div className="container">
          <div className="row align-items-start">
            ...
            <div className="col-lg-6 col-md-12 mb-4">
              <h1 className="section-title">Benefits of Hire a Hire Full Stack</h1>
            ...
            {/* Right Column */}
            <div className="col-lg-6 col-md-12 mb-4">
              <h1 className="section-title">Pavalsoft Hire Full Stack</h1>
      ...
      {/* 3 section  */}
      <div className='hirefullstack-content-form'>
