...
const Hireuiux = () => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = require("../Asset/Hire UI UX Developers banner.png");
    img.onload = () => setIsLoaded(true);
  }, []);


  return (
    <div className='hireui'>
      {/* 1 section */}
      <div className="hireui-front-page"style={{ display: isLoaded ? "flex" : "none" }}>
      <div className="container p-0">
          {/* Left Side Content */}
          <div className="hireui-front-page-center row">
            <div className="col-md-6 hireui-front-heading p-0">
              <h1>Hire UI UX</h1>
              <p>
        ...
        <div className="container">
          <div className="row align-items-start">
            ...
            <div className="col-lg-6 col-md-12 mb-4">
              <h1 className="section-title">Hire a Web Developer program</h1>
            ...
            {/* Right Column */}
            <div className="col-lg-6 col-md-12 mb-4">
              <h1 className="section-title">Benefits of hiring web developers </h1>
              <div className="logo-hire">
      ...
      {/* 3 section  */}
      <div className='hireui-content-form'>
