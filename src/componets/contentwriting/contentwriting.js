...
const Contentwriting = () => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = require("../Asset/Content Writing.png");
  ...
  return (
    <div className='cw'>
      {/* 1 section */}
      <div className="Content-front-page" style={{ display: isLoaded ? "flex" : "none" }}>
      <div className="container p-0">
          {/* Left Side Content */}
          <div className="Content-front-page-center row">
            <div className="col-md-6 Content-front-heading p-0">
      ...
      <div className="h-w-b">
        <div className="container">
          <div className="row align-items-start">
            ...
            {/* Right Column */}
            <div className="col-lg-6 col-md-12 mb-4">
              <h1 className="section-title">Pavalsoft Content Writing Expertise</h1>
              <div className="logo-hire">
      ...
      {/* 3 section  */}
      <div className='cw-content-form'>
        <div className="content-layout">
          <div className="content-left-side">
            <h1>Why Choose Pavalsoft for Content Writing?</h1>
            <p>
              At Pavalsoft, our team of skilled writers combines creativity with a strategic approach to deliver content that aligns with your goals. We understand the importance of tone, style, and relevance, ensuring that every piece of content strengthens your brand identity and meets audience expectations.
            </p>
            <h1>Let’s Create Together</h1>
            <p>
              Empower your brand with Pavalsoft's professional content writing services. Whether you're looking to inform, persuade, or inspire, we create content that drives results. Contact us today to discuss your content needs and unlock the potential of compelling storytelling!
            </p>
