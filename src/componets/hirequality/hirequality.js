...
import './hirequality.css'
import axios from 'axios';
import Swal from 'sweetalert2';


const Hirequalityanalyst = () => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = require("../Asset/Hire Quality Analyst banner.png");
    img.onload = () => setIsLoaded(true);
  }, []);


  return (
    <div className='hirequality'>
      {/* 1 section */}
      <div className="hirequality-front-page"style={{ display: isLoaded ? "flex" : "none" }}>
      <div className="container p-0">
          {/* Left Side Content */}
          <div className="hirequality-front-page-center row">
            <div className="col-md-6 hirequality-front-heading p-0">
      ...
      {/* 3 section  */}
      <div className='hirequality-content-form'>
...
export default Hirequalityanalyst
